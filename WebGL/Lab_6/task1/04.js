...
function initVertexBuffers(gl) {
  ...
  //исходный реугольник
    ...
    // console.log(modelMoveMatrix.toString());
    // gl.uniformMatrix4fv(u_ModelMatrix, false, modelMoveMatrix);
  //------------------------------------------------------------
  
  	// let modelMoveMatrix = glMatrix.mat4.create();
	// glMatrix.mat4.fromTranslation(modelMoveMatrix,[0.2,0.2,0.0]);
  // console.log(modelMoveMatrix.toString());
  // gl.uniformMatrix4fv(u_ModelMatrix, false, modelMoveMatrix);
  
  //------------------------------------------------------------
  // let modelRotateMatrix = glMatrix.mat4.create();
	 // glMatrix.mat4.fromRotation(modelRotateMatrix,Math.PI/4,[0,0,1]);
  // console.log(modelRotateMatrix.toString());
   // gl.uniformMatrix4fv(u_ModelMatrix, false, modelRotateMatrix);
  
  
   //------------------------------------------------------------
   // let modelScaleMatrix = glMatrix.mat4.create();
   // glMatrix.mat4.fromScaling(modelScaleMatrix,[0.5,0.5,1.0]);
   // console.log(modelScaleMatrix.toString());
   // gl.uniformMatrix4fv(u_ModelMatrix, false, modelScaleMatrix);
