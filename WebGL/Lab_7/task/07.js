...
function main() {
  ...
  let modelPerspectiveMatrix = glMatrix.mat4.create();
   glMatrix.mat4.perspective(modelPerspectiveMatrix, 1.5, 1, 0.01, 10) //perspective
  //glMatrix.mat4.frustum(modelPerspectiveMatrix, -0.01, 0.01, -0.01, 0.01, 0.01, 10) //frustum(второй способ)
  
  //одноточечная проекция
   //glMatrix.mat4.lookAt(modelViewMatrix, [0,0,1],[0,0,0],[1,0, 0]);
  //двухточечная проекция
  //glMatrix.mat4.lookAt(modelViewMatrix, [0,1,1],[0,0,0],[1,0, 0]);
  //трехточечная проекция
   //glMatrix.mat4.lookAt(modelViewMatrix, [1,1,1],[0,0,0],[0,0, 1]);
